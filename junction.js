...
function JunctionApp() {
  ...
  useEffect(function () {
    ...
    var draw = function draw(fc) {
      ...
      try {
        for (var _iterator22 = fc.features[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
          ...
          var st = STYLE[(f.properties || {}).kind] || { color: '#8794a0', weight: 1, opacity: .85 };
          var g = f.geometry;
    ...
    if (cadRef.current) draw(cadRef.current);else fetch('data/junction_cad.geojson?v=2026-07-27').then(function (r) {
      return r.json();
    }).then(function (fc) {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          ' הצג תשריט CAD מדויק (שפות כביש · איים · תח״צ · ריהוט)'
        ),
        React.createElement(
          'label',
