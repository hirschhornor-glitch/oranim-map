...
var CHANGES_URL = 'data/junction_changes.json?v=2026-07-27e';
...
function JunctionApp() {
  ...
  useEffect(function () {
    ...
    if (cadRef.current) draw(cadRef.current);else fetch('data/junction_cad.geojson?v=2026-07-27d').then(function (r) {
      return r.json();
    }).then(function (fc) {
