...
HAFRASH_DOMAIN_RX = [
    ("education", r'(תיכון|חטיב|אולפנ|מדרשי|ישיב|על[\- ]?יסודי|בתי ספר|בית ספר|בי"?ס|בי״ס|ביה"?ס|ביה״ס|בית-ספר|יסודי|(?:מעון|מעונות)(?!\s*ל?בעלי)|פעוטון|גן ילדים|גני ילדים|גנון|כיתת? גן|כיתות גן|חינוך)'),
    ...
    ("welfare",   r'(רווחה|שירותים חברתיים|חברתי|שימושי חברה|שירותי חברה|חברה וקהיל|מועדון נוער|מועדונית|נוער|קשיש|גיל שלישי|אזרחים ותיקים|תשוש|מרכז יום|נכים|מוגבלויות|שיקום|דיר(?:ת|ות) קלט|דיור ציבורי|דיור מוגן|דיור מיוחד)'),
