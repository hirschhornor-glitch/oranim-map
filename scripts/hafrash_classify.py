...
HAFRASH_DOMAIN_RX = [
    ...
    # KEEP IN STEP with HAFRASH_DOMAIN_RX in src/app.jsx.
    # NOT גלריה: here it almost always means a MEZZANINE, not an art gallery —
    # 101-0813329's "שטח לצרכי ציבור בקומת קרקע וגלריה" is a floor level.
    ("culture",   r'(מתנ"?ס|מתנ״ס|מרכז קהילתי|מועדון קהילתי|שלוחת מתנ|קהיל|ספריי|ספריה|תרבות|אמנות|אומנות|אולם מופעים|אודיטור|קונסרבטור|פנאי|מוזיאון|שימושי ציבור|שימ.*קהיל)'),
]
