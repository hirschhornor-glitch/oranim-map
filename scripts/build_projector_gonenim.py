...
CROSSWALK_TABLE_DATA = {
    ...
    ("גוננים א-ו", "ממעבר חציה מס'14"): {
        ...
        "justification": "מעבר המשכי לה\"ר",
        "type": "",
        "implications": "צמוד לצומת נוסף, אין אפשרות לתכנן מעבר בשלב זה. כאשר יתוכנן מתחמית (בהתאם להמלצת הפרויקטור) אזי יש לשלב בתכנון את המעבר, באזור החיבור לאמוראים.",
        "source": "גוננים מרחב ציבורי 05.2024, עמ' 12 (יועצת תנועה: יורוברידג')",
    },
