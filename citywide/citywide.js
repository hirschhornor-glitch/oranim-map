...
(function () {
  ...
  var REPORTS = {
    ...
    fund: {
      ...
      note: "<b>איך לקרוא:</b> היעדר תכנית פירושו <b>לא נמצא</b> ולא <b>אין</b>. שורות המסומנות OCR נקראו ממסמך סרוק; כל מספר שמקורו ב-OCR אומת בקריאה ויזואלית של המסמך, וסכומי הקרן כולם מגיעים משכבת טקסט.",
      rows: function () {
